...
#		Here I must switch to the resolution to result, how ?
		var height = ProjectSettings.get_setting("display/window/size/height")
		var width = ProjectSettings.get_setting("display/window/size/width")		
		
		print("Size W: " + str(width) + "H:"+str(height))
		print("OK Then setup the current resolution to")
		if (width/height) > 1:
			ProjectSettings.set_setting("display/window/size/width", landscape if width else height)
			ProjectSettings.set_setting("display/window/size/height", landscape if height else width)
		else:
			ProjectSettings.set_setting("display/window/size/width", height)
			ProjectSettings.set_setting("display/window/size/height", width)			
